            ...
            <div class="form-group">
                ...
                <select name="codigo_carrera" id="codigo_carrera" class="form-control">
                    ...
                    <?php foreach ($carreras as $carrera): ?>
                        <option value="<?= esc($carrera['codigo_carrera']) ?>" <?= (esc(old('codigo_carrera') ?? $alumno['codigo_carrera']) === $carrera['codigo_carrera']) ? 'selected' : '' ?>><?= esc($carrera['nombre_carrera']) ?></option>
                    <?php endforeach; ?>
                </select>
            </div>
